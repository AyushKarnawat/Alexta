...
def get_welcome_response():
    ...
    speech_output = "You can send a text message to any number by saying, " \
                    "send a text to two zero one eight four nine three eight four eight saying this works."

    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Sorry I couldn't catch that. Please tell me what message " \
                    "you want to send by saying, send a text to two zero one eight four nine three eight four eight saying this works."
...
def set_message_in_session(intent, session):
    ...
    if 'Message' in intent['slots']:
        ...
        reprompt_text = "I was not able to send your message. " \
                        "You can send a text message to any number by saying, send a text to two zero one eight four nine three eight four eight saying this works."
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))
